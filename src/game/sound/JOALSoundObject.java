...
//    private final static String SOUND_DIR = "resources/sfx/"; // where the WAV files are stored
//    int angleLis = 0;
//
//    public JOALSoundObject() {
